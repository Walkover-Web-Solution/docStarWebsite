...
const EmbedEditorPage: React.FC = () => {
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 border-2 border-stone-300 text-stone-700 rounded-xl font-semibold text-lg hover:border-emerald-600 hover:text-emerald-600 transition-colors"
...
export default EmbedEditorPage
