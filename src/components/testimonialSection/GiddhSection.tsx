      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-[280px_1fr] gap-12 items-center">
          <figure className="" style={{ height: 280, width: 280 }}>
            <img
              src="https://5.imimg.com/data5/SELLER/Default/2023/10/354091050/VE/BD/FO/7980257/giddh-gst-software.jpg"
              alt="Giddh Team Member"
          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-gray-600 text-base">
                Giddh Team, Solutions Architect{" "}
