      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-[280px_1fr] gap-12 items-center">
          <figure className="" style={{ height: 280, width: 280 }}>
            <img
              src="https://cdn.prod.website-files.com/637e7afd450ee24fb878e5b0/68539e0e1f37b28674f92a51_orig.jpeg"
              alt="MSG91 Team Member"
          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-gray-600 text-base">
                Selma Bennamane, Solutions Architect{" "}
